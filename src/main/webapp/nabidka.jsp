...
<%--KDYZTAK ZATIM NEPOUZIVEJ INTERPUNKCI TEN JSP S TIM MA PROBLEMY--%>
            ...
            <div class="filter">
                <div class="horni-filter">
                    ...
                    <form class="filter-form">
                        ...
                        <label for="start">Začátek půjčky:</label>
                        <div class="filter-inside">

                            <input type="date" id="start" name="trip-start" value="" min="2020-01-01" max="2021-12-31">
                        </div>

<%--CHYBA V HTML S TIMHLE LABELEM (INVALID ID REFERENCE)--%>
                        <label for="end">Konec půjčky:</label>
                        ...
                        <div data-role="rangeslider" class="filter-inside">
                            <label for="range-1a">Cena za den:</label>
                            <input type="range" name="range-1a" id="range-1a" min="0" max="3500" value="0"
                                data-popup-enabled="true" data-show-value="true">
                            <label for="range-1b">Rangeslider:</label>
                            <input type="range" name="range-1b" id="range-1b" min="0" max="3500" value="3500"
                                data-popup-enabled="true" data-show-value="true">
                        </div>
            ...
            <h2 class="nabidka-nadpis">Nabídka vozidel:</h2>
