...
<main class="main">
    <div class="container main_description">
        <h3>Add Car</h3>
        <form method="POST" enctype="multipart/form-data" action="doAddCar" class="admin-form">
            ...
            <label>Car category(SEDAN/COMBI/SUV/HATCHBACK/CABRIOLET/PICKUP/VAN): </label><input type="string"
                                                                                                name="carcategory"
                                                                                                required><br>
        ...
        <security:authorize access="hasRole('ROLE_ADMIN')">
            <h3>Add User</h3>
            <form action="doAddUser" class="admin-form">
        ...
        <fieldset ${pagingcarNext}>
            <form action="adminPagepaged" class="paging">
